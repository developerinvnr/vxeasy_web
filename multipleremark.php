<div style="background-color: #F3F4F9;width: 100%;min-height:100px;overflow: auto;padding:4px;border-radius: 4px;border: 2px solid #E2E4E5;font-size: 12px;">
	<h6>Remarks Chat</h6>
	...
	<textarea id="nrem" rows="1" style="width: 85%;padding:5px;margin-top:4px;margin-bottom:4px;border-radius: 4px;float: left;" onkeypress="onChatPress();"></textarea>
	<button id="chatbtn" type="button" style="float: left;width: 15%;padding:4px;margin-top:4px;margin-bottom:4px;border-radius: 4px;" onclick="addnr('<?=$exp['ExpId']?>','<?=$_SESSION['EmployeeID']?>','<?=$_SESSION['EmpRole']?>','<?=$myname?>','<?=$othname?>')">Submit</button>
