 ...
 <?php
   ...
   if(isset($_REQUEST['inpage']) && $_REQUEST['inpage']=='showclaim'){
	...
	if(isset($_REQUEST['expid'])){  //this add button shows when add new files to claim uploades
		...
		if($selu['ClaimAtStep']<=2 && ($_SESSION['EmpRole']=='E' || $_SESSION['EmpRole']=='A' || $_SESSION['EmpRole']=='P')){
			?>
	...
	}elseif($_SESSION['EmpRole']=='E' || $_SESSION['EmpRole']=='A' || $_SESSION['EmpRole']=='P'){ //this add button shows when first time uploading files to claim
		?>
