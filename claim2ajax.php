...
if($_POST['act']=='approveClaim')
{
	...
	$up=mysql_query("UPDATE y".$_SESSION['FYearId']."_expenseclaims SET ClaimStatus='Approved', ClaimAtStep=4, ApprBy='".$_SESSION['EmployeeID']."', `ApprTAmt`='".$_POST['atamt']."', `ApprTRemark`='".$r."', `ApprDate`='".date("Y-m-d")."' where ExpId='".$_POST['expid']."'");
...
/******* Verifier Start ******************//******* Verifier Start ******************/
	...
	$up=mysql_query("UPDATE y".$_SESSION['FYearId']."_expenseclaims SET ClaimStatus='Verified', VerifyBy='".$_SESSION['EmployeeID']."', `VerifyTAmt`='".$_POST['vtamt']."', `VerifyTRemark`='".$r."', `VerifyDate`='".date("Y-m-d")."' where ExpId='".$_POST['expid']."'");
	//$up=mysql_query("UPDATE y".$_SESSION['FYearId']."_expenseclaims SET ClaimStatus='Verified', ClaimAtStep=6, VerifyBy='".$_SESSION['EmployeeID']."', `VerifyTAmt`='".$_POST['vtamt']."', `VerifyTRemark`='".$r."', `VerifyDate`='".date("Y-m-d")."' where ExpId='".$_POST['expid']."'");
	//`ApprTAmt`='".$_POST['vtamt']."',`FinancedTAmt`='".$_POST['vtamt']."'
