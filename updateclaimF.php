...
if(isset($_POST['UpdateLodging']) || isset($_POST['draftLodging'])){
	...
	if($_SESSION['EmpRole']=='F'){
		...
		$up=mysql_query("UPDATE `y".$_SESSION['FYearId']."_expenseclaims` set `BillDate`='".$BillDate."',`Remark`='".$_POST['Remark']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `FinancedBy`='".$_SESSION['EmployeeID']."', `FinancedTAmt`='".$_POST['FinanceEditAmount']."', `FinancedDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
		...
		if($up){
			...
			for($i=1;$i<=$count;$i++){
				...
				if(isset($_POST['fdid'.$i]) && $_POST['fdtitle'.$i]!='' && $_POST['fdamount'.$i]!=''){
					mysql_query("update `y".$_SESSION['FYearId']."_expenseclaimsdetails` set `Title`='".$_POST['fdtitle'.$i]."',`FinanceEditAmount`='".$_POST['fdFinanceEditAmount'.$i]."',`FinanceRemark`='".$_POST['fdFinanceRemark'.$i]."' where ecdId='".$_POST['fdid'.$i]."'");
				}elseif($_POST['fdtitle'.$i]!='' && $_POST['fdamount'.$i]!=''){
					
					mysql_query("INSERT INTO `y".$_SESSION['FYearId']."_expenseclaimsdetails`( `ExpId`,`Title`,`FinanceEditAmount`,`FinanceRemark`) VALUES ('".$_POST['expid']."','".$_POST['fdtitle'.$i]."','".$_POST['fdFinanceEditAmount'.$i]."','".$_POST['fdFinanceRemark'.$i]."')");
				}
			}
	...
	if($_SESSION['EmpRole']=='F'){
		...
		$up=mysql_query("UPDATE `y".$_SESSION['FYearId']."_expenseclaims` set `BillDate`='".$JourneyStartDt."',`Remark`='".$_POST['Remark']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `FinancedBy`='".$_SESSION['EmployeeID']."', `FinancedTAmt`='".$_POST['FinanceEditAmount']."', `FinancedDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
	...
	if($_SESSION['EmpRole']=='F'){
		...
		$up=mysql_query("UPDATE `y".$_SESSION['FYearId']."_expenseclaims` set `BillDate`='".$JourneyEndDt."',`Remark`='".$_POST['Remark']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `FinancedBy`='".$_SESSION['EmployeeID']."', `FinancedTAmt`='".$_POST['FinanceEditAmount']."', `FinancedDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
	...
	if($_SESSION['EmpRole']=='F'){
		...
		$up=mysql_query("UPDATE `y".$_SESSION['FYearId']."_expenseclaims` set `BillDate`='".$DocketBookedDt."',`Remark`='".$_POST['Remark']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `FinancedBy`='".$_SESSION['EmployeeID']."', `FinancedTAmt`='".$_POST['FinanceEditAmount']."', `FinancedDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
	...
	if($_SESSION['EmpRole']=='F'){
		...
		`Remark`='".$_POST['Remark']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `FinancedBy`='".$_SESSION['EmployeeID']."', `FinancedTAmt`='".$_POST['FinanceEditAmount']."', `FinancedDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
	...
	if($_SESSION['EmpRole']=='F'){
		...
		$up=mysql_query("UPDATE `y".$_SESSION['FYearId']."_expenseclaims` set `BillDate`='".$BillDate."',`Remark`='".$_POST['mremarks']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `FinancedBy`='".$_SESSION['EmployeeID']."', `FinancedTAmt`='".$_POST['FinanceEditAmount']."', `FinancedDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
...
$sel=mysql_query("select * from `y".$_SESSION['FYearId']."_expenseclaims` where ExpId=".$_POST['expid']);
$rsel=mysql_fetch_assoc($sel); $Famt=$rsel['FinancedTAmt'];


$totpaid4=mysql_query("SELECT SUM(FinancedTAmt) as paid FROM `y".$_SESSION['FYearId']."_expenseclaims` e WHERE `ClaimMonth`='".$rsel['ClaimMonth']."' and `ClaimYearId`='".$_SESSION['FYearId']."' and e.CrBy=".$rsel['CrBy']." and ClaimStatus!='Deactivate' and ClaimStatus!='Draft' and FinancedBy>0"); $clm4=mysql_fetch_assoc($totpaid4);
$totFAmt=$clm4['paid'];   
	...
	<script type="text/javascript">
		setTimeout(function(){
			...
			setTimeout(function(){
				...
				window.parent.document.getElementById("FinTAmt").value=<?=$totFAmt?>;
				window.parent.document.getElementById("FinPAmt").value=<?=$totFAmt?>;
				window.parent.document.getElementById("<?=$_POST['expid']?>financetamt").value=<?=$Famt?>;
