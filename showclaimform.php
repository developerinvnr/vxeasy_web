					...
					<td colspan="4">
						...
						<table class="table table-sm faredettbl" >
							...
							<tr>
								...
								<td class="table-active">
									<?php if(in_array($exp['ClaimStatus'], array("Filled", "Verified", "Approved","Financed")) || $_SESSION['EmpRole']=='M'){ ?>
									<input  class="form-control text-right" id="Amount" style="background-color:<?=$Amount?>;" value="<?php if($exp['FilledTAmt']>0){echo $exp['FilledTAmt'];}else{ echo 200; }?>"  readonly required >
									
									<input type="hidden" name="Amount" value="200" readonly required>
