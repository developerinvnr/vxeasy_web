...
if(isset($_POST['UpdateLodging']) || isset($_POST['draftLodging'])){
	...
	if($_SESSION['EmpRole']=='V'){	
		...
		$up=mysql_query("UPDATE `y".$_SESSION['FYearId']."_expenseclaims` set `ClaimId`='".$_POST['claimtype']."', `BillDate`='".$BillDate."',`Remark`='".$_POST['Remark']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `VerifyBy`='".$_SESSION['EmployeeID']."', `VerifyTAmt`='".$_POST['VerifierEditAmount']."', `VerifyDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
		...
		if($up){
			...
			for($i=1;$i<=$count;$i++){
				if(isset($_POST['fdid'.$i]) && $_POST['fdtitle'.$i]!='' && $_POST['fdamount'.$i]!=''){
					mysql_query("update `y".$_SESSION['FYearId']."_expenseclaimsdetails` set `Title`='".$_POST['fdtitle'.$i]."',`VerifierEditAmount`='".$_POST['fdVerifierEditAmount'.$i]."',`VerifierRemark`='".$_POST['fdVerifierRemark'.$i]."',VerifiedDate='".date("Y-m-d")."' where ecdId='".$_POST['fdid'.$i]."'");
				}elseif($_POST['fdtitle'.$i]!='' && $_POST['fdamount'.$i]!=''){
					
					mysql_query("INSERT INTO `y".$_SESSION['FYearId']."_expenseclaimsdetails`( `ExpId`,`Title`,`VerifierEditAmount`,`VerifierRemark`,VerifiedDate) VALUES ('".$_POST['expid']."','".$_POST['fdtitle'.$i]."','".$_POST['fdVerifierEditAmount'.$i]."','".$_POST['fdVerifierRemark'.$i]."','".date("Y-m-d")."')");
				}
			}
			//this is amount details insert code..................................................................
		}
	...
	if($_SESSION['EmpRole']=='V'){
		...
		$up=mysql_query("UPDATE `y".$_SESSION['FYearId']."_expenseclaims` set `ClaimId`='".$_POST['claimtype']."', `BillDate`='".$JourneyStartDt."',`Remark`='".$_POST['Remark']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `VerifyBy`='".$_SESSION['EmployeeID']."', `VerifyTAmt`='".$_POST['VerifierEditAmount']."', `VerifyDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
	...
	if($_SESSION['EmpRole']=='V'){
		...
		$up=mysql_query("UPDATE `y".$_SESSION['FYearId']."_expenseclaims` set `ClaimId`='".$_POST['claimtype']."', `BillDate`='".$JourneyEndDt."',`Remark`='".$_POST['Remark']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `VerifyBy`='".$_SESSION['EmployeeID']."', `VerifyTAmt`='".$_POST['VerifierEditAmount']."', `VerifyDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
	...
	if($_SESSION['EmpRole']=='V'){
		...
		$up=mysql_query("UPDATE `y".$_SESSION['FYearId']."_expenseclaims` set `ClaimId`='".$_POST['claimtype']."', `BillDate`='".$DocketBookedDt."',`Remark`='".$_POST['Remark']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `VerifyBy`='".$_SESSION['EmployeeID']."', `VerifyTAmt`='".$_POST['VerifierEditAmount']."', `VerifyDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
	...
	if($_SESSION['EmpRole']=='V'){
		...
		`Remark`='".$_POST['Remark']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `VerifyBy`='".$_SESSION['EmployeeID']."', `VerifyTAmt`='".$_POST['VerifierEditAmount']."', `VerifyDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
	...
	if($_SESSION['EmpRole']=='V'){
		...
		$up=mysql_query("UPDATE `y".$_SESSION['FYearId']."_expenseclaims` set `ClaimId`='".$_POST['claimtype']."', `BillDate`='".$BillDate."',`Remark`='".$_POST['mremarks']."', `ClaimStatus`='".$clmsts."', `ClaimMonth`='".date("m",strtotime($BillDate))."', `VerifyBy`='".$_SESSION['EmployeeID']."', `VerifyTAmt`='".$_POST['VerifierEditAmount']."', `VerifyDate`='".date("Y-m-d")."' where ExpId=".$_POST['expid']);
