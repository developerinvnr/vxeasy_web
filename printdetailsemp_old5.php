...
{   include 'config.php';
	...
	return '('.$un['EmpCode'].') '.$un['Fname'].' '.$un['Sname'].' '.$un['Lname'];
}
...
<tr>
 ...
 &nbsp;<b style="font-size:16px;">{Monthly Claim Details : <?=date('F', mktime(0,0,0,$mlist['Month'], 1, date('Y'))).' ('.$ry['Year'].')';?> </b>} 
 &nbsp;&nbsp;<b>Claimer</b>:<?=getUser($mlist['EmployeeID'])?>
 &nbsp;&nbsp;<b>Total Claim</b>:<?=$rTot['TotClaim'];?>
 &nbsp;&nbsp;<b>Amount</b>:<?=$rTot['TotClamAmt'];?>
 </td>
 <td style="width:5%;text-align:right;"><a href="#" onClick="printp()"><a href="#" onClick="printpdf(<?=$_REQUEST['e'].','.$_REQUEST['m'].','.$_REQUEST['y'].','.$_REQUEST['n'].','.$_SESSION['CompanyId']?>)">pdf</a></a></td>
