				...
				<table class="table table-sm claimtable">
					...
					<thead class="thead-dark">
						...
						<tr>
							...
							<th scope="row">
								<select id="claimtype" name="claimtype" class="claimheadsel form-control pull-left" form="claimform" >
									<option value="">Select</option>
									<?php
									$c=mysql_query("select ct.ClaimId,ct.ClaimName from claimtype ct, y".$_SESSION['FYearId']."_empclaimassign asg where ct.ClaimStatus='A' and asg.ClaimId=ct.ClaimId and asg.EmployeeID=".$_SESSION['EmployeeID']);
