...
if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST")
{
  ...
  // $file_tmp=$_FILES["files"]["tmp_name"][$key];
    ...
    $userfolder = $userYearlyFolder. $_POST['uuid'] . "/";
  ...
  if(isset($_POST['prevRequestText']) && $_POST['prevRequestText']!=''){
    ...
    echo '<iframe src="uploadimgPreBeforeUpdate.php?imglink='.$RequestText.'&uuid='.$_POST['uuid'].'" border="1" style="width:100%;height:'.$sh.'%;"/></iframe>';
