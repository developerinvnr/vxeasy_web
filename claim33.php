			...
			<div class="table-responsive">
				...
				<thead class="thead-dark">
					...
					<tr>
						...
						<select class=" claimheadsel form-control pull-left" id="claimYear" name="claimYear"  required form="claimform"  onchange="disfMonth(this.value)">
						    <option value="">Select</option>
						    <?php
						    $y=mysql_query("SELECT * FROM `financialyear` WHERE `Status`='Active'");
							while($fy=mysql_fetch_assoc($y)){
								print '<option value="'.$fy['YearId'].'" >'.$fy['Year'].'</option>';
					...
					<tr>
						...
						<span id="monthselectspan">
							<select class=" claimheadsel form-control pull-left" id="claimMonth" name="claimMonth" required  form="claimform" onchange="disfClaim()" disabled>
							    <option value="">Select</option>
							</select>
						</span>
